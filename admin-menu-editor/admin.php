...
<script id="menu-spacer-tmpl" type="text/x-jquery-tmpl">
	<li id="" class="menu-item menu-item-custom pending"
		...
		<div class="menu-item-settings" id="menu-item-settings-21" style="display: none; ">
			<div class="menu-item-actions description-wide submitbox">
				<a class="item-delete submitdelete deletion" id="" href="#"><?php echo __('Remove', 'framework'); ?></a> <span class="meta-sep"> | </span> <a class="item-cancel submitcancel" id="cancel-21" href="<?php admin_url('nav-menus.php?edit-menu-item=21&amp;cancel=1346668427#menu-item-settings-21'); ?>"><?php echo __('Cancel', 'framework'); ?></a>
			</div>
